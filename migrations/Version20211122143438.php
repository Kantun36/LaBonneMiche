...
final class Version20211122143438 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, id_article INT NOT NULL, titre VARCHAR(255) NOT NULL, contenu VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE paragraphe (id INT AUTO_INCREMENT NOT NULL, article_id INT DEFAULT NULL, numero_paragraphe INT NOT NULL, titre_paragraphe VARCHAR(255) NOT NULL, contenu_paragraphe LONGTEXT NOT NULL, INDEX IDX_4C1BA9B67294869C (article_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
